...
import img0 from '../../../components/react/challenge/img-0.jpg';
        ...
        <div className='w-full'>
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className='w-full'>
                        <h1 className="text-2xl lg: text-xl lg:text-5xl font-bold"><span className='underlined'>challenge yourself</span></h1>
                        <div className="py-6">
                            <div className='w-full'>
                        ...
                        <ExternalLink href='https://jazzy-churros-11f1e7.netlify.app/'><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About challenge yourself website</h2>
