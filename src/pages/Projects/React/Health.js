...
import img0 from '../../../components/react/health/img-0.jpg';
import img1 from '../../../components/react/health/img-1.png';
import img2 from '../../../components/react/health/img-2.png';
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className='w-full'>
                        ...
                        <div className="py-6">
                            <div className='w-full'>
                                ...
                                <ul className='text-start flex justify-center place-items-center w-full'>
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/DAILY-HEALTH-ACTIVITIES' className='px-2 flex justify-center place-items-center '>
                        ...
                        <ExternalLink href='https://transcendent-caramel-cfd489.netlify.app/'><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About health activities website</h2>
            <div className="py-6 px-3 lg:px-10 lg:flex">
                <div className='lg:w-3/4 lg:mr-10'>
                    ...
                    <div className='w-full'>
                        ...
                        <p className='text-justify py-2'>
                            Whenever users come to health activities website, they expect intuitive interfaces and extraordinary experiences that operate smoothly on different devices whether desktop, phone, or tablets.
                        </p>
                        <p className='text-justify py-2'>
                            Setting a UX goal for  health activities website is all about thinking about the interests of the customers who would use the service you’re creating (site, application, etc.) and then taking it a step further.
                        </p>
                    </div>
                </div>
