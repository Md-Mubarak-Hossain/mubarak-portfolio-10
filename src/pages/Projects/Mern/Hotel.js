...
import img1 from '../../../components/mern/hotel/img-1.png';
import img2 from '../../../components/mern/hotel/img-2.png';
import img3 from '../../../components/mern/hotel/img-3.png';
import img4 from '../../../components/mern/hotel/img-4.png';
import img5 from '../../../components/mern/hotel/img-5.png';
import img6 from '../../../components/mern/hotel/img-6.png';
import img7 from '../../../components/mern/hotel/img-7.png';
import img8 from '../../../components/mern/hotel/img-8.png';
import img10 from '../../../components/mern/hotel/img-10.png';
import img11 from '../../../components/mern/hotel/img-11.png';
import img12 from '../../../components/mern/hotel/img-12.png';
import img9 from '../../../components/mern/hotel/page-9.png';
                        ...
                        <div className="py-6">
                            <div className='w-full'>
                                ...
                                <ul className='text-start flex justify-center place-items-center w-full'>
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/hotel-night-app' className='px-2 flex justify-center place-items-center '>
                                    ...
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/hotel-night-server' className='flex justify-center place-items-center '>
                                        <p> <FaServer className='mx-1'>
                                        </FaServer></p><p>server site</p><VscLinkExternal className='mx-1'></VscLinkExternal></ExternalLink>
                                </ul>
                            </div>
                        </div>
                        <ExternalLink href='https://hotel-night-app-10.web.app/'><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About hotel night website</h2>
            <div className="py-6 px-3 lg:px-10 lg:flex">
                <div className='lg:w-3/4 lg:mr-10'>
                    ...
                    <div className='full'>
                        ...
                        <p className='text-justify py-2'>
                            Whenever users come to hotel night website, they expect intuitive interfaces and extraordinary experiences that operate smoothly on different devices whether desktop, phone, or tablets.
                        </p>
                        <p className='text-justify py-2'>
                            Setting a UX goal for hotel night website is all about thinking about the interests of the customers who would use the service you’re creating (site, application, etc.) and then taking it a step further.
                        </p>
                    </div>
                </div>
