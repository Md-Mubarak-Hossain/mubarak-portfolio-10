...
import img1 from '../../../components/mern/school/img-1.png';
import img2 from '../../../components/mern/school/img-2.png';
import img3 from '../../../components/mern/school/img-3.png';
import img4 from '../../../components/mern/school/img-4.png';
import img5 from '../../../components/mern/school/img-5.png';
import img6 from '../../../components/mern/school/img-6.png';
import img7 from '../../../components/mern/school/img-7.png';
import img8 from '../../../components/mern/school/img-8.png';
import img9 from '../../../components/mern/school/img-9.png';
import img10 from '../../../components/mern/school/img-10.png';
import img11 from '../../../components/mern/school/img-11.png';
import img12 from '../../../components/mern/school/img-12.png';
import img13 from '../../../components/mern/school/img-13.png';
import img14 from '../../../components/mern/school/img-14.png';
import img15 from '../../../components/mern/school/img-15.png';
import img16 from '../../../components/mern/school/img-16.png';
import img17 from '../../../components/mern/school/img-17.png';
import img19 from '../../../components/mern/school/img-19.png';
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content grid grid-cols-1 lg:grid-cols-2">
                    <div className='w-full h-full'>
                        <img src={img3} className="rounded-lg shadow-2xl w-full h-full" alt=''
                        />
                    </div>
                    <div className='w-full'>
                        <h1 className="text-2xl lg: text-xl lg:text-5xl font-bold"><span className='underlined'>PROGRAMMING SCHOOL</span></h1>
                        <div className="py-6">
                            <div className='w-full'>
                        ...
                        <div className="py-6">
                            <div className='w-full'>
                                ...
                                <ul className='text-start flex justify-center place-items-center w-full'>
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/PROGRAMMING-SCHOOL-CLIENT-SITE' className='px-2 flex justify-center place-items-center '>
                                    ...
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/PROGRAAMING-SCHOOL-SERVER' className='flex justify-center place-items-center '>
                                        <p> <FaServer className='mx-1'>
                                        </FaServer></p><p>server site</p><VscLinkExternal className='mx-1'></VscLinkExternal></ExternalLink>
                                </ul>
                            </div>
                        </div>
                        {/* https://programming-school-10.web.app/ */}
                        <ExternalLink target="_private"><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About programming school website</h2>
            <div className="py-6 px-3 lg:px-10 lg:flex">
                <div className='lg:w-3/4 lg:mr-10'>
                    ...
                    <div className='w-full'>
                        ...
                        <p className='text-justify py-2'>
                            Whenever users come to programming school website, they expect intuitive interfaces and extraordinary experiences that operate smoothly on different devices whether desktop, phone, or tablets.
                        </p>
                        <p className='text-justify py-2'>
                            Setting a UX goal for programming school website is all about thinking about the interests of the customers who would use the service you’re creating (site, application, etc.) and then taking it a step further.
                        </p>
                    </div>
                </div>
