...
import img0 from '../../../components/css/panda/img-0.jpg';
import img1 from '../../../components/css/panda/img-1.png';
import img2 from '../../../components/css/panda/img-2.png';
import img3 from '../../../components/css/panda/img-3.png';
import img4 from '../../../components/css/panda/img-4.png';
import img5 from '../../../components/css/panda/img-5.png';
import img6 from '../../../components/css/panda/img-6.png';
import img7 from '../../../components/css/panda/img-7.png';
        ...
        <div className='w-full'>
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className='w-full'>
                        <h1 className="text-xl lg:text-3xl font-bold"><span className='underlined'>PANDA E-COMMERCE FASHION</span></h1>
                        <div className="py-6">
                            <div className='w-full'>
                        ...
                        <div className="py-6">
                            <div className='w-full'>
                                <span className='resume mb-5'> <h2 className='text-violet-900  flex place-items-center w-full mb-2'>Visit <FaGithub className='mx-2'></FaGithub>repository</h2></span>
                                <ul className='text-start flex justify-center place-items-center w-full'>
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/panda-ecommerce-bootstrap' className='px-2 flex justify-center place-items-center '>
                        ...
                        <ExternalLink href='https://monumental-flan-93f753.netlify.app/'><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About Panda fashion website</h2>
