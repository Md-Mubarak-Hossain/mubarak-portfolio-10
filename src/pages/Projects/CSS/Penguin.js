...
import img0 from '../../../components/css/penguin/img-0.png';
import img1 from '../../../components/css/penguin/img-1.png';
import img2 from '../../../components/css/penguin/img-2.png';
import img3 from '../../../components/css/penguin/img-3.png';
import img4 from '../../../components/css/penguin/img-4.png';
        ...
        <div className='w-full'>
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className='w-full'>
                        <h1 className="text-xl lg:text-3xl font-bold"><span className='underlined'>PENGUIN FASHION</span></h1>
                        <div className="py-6">
                            <div className='w-full'>
                        ...
                        <div className="py-6">
                            <div className='w-full'>
                                ...
                                <ul className='text-start flex justify-center place-items-center w-full'>
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/penguin-nike-feshion-tailwind-javascript' className='px-2 flex justify-center place-items-center '>
                        ...
                        <ExternalLink href='https://elegant-cucurucho-21f8d3.netlify.app/'><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About penguin fashion website</h2>
