...
import img0 from '../../../components/Html/cup/img-0.png';
import img1 from '../../../components/Html/cup/img-1.png';
import img2 from '../../../components/Html/cup/img-2.png';
import img3 from '../../../components/Html/cup/img-3.png';
import img4 from '../../../components/Html/cup/img-4.png';
import img5 from '../../../components/Html/cup/img-5.png';
import img6 from '../../../components/Html/cup/img-6.png';
        ...
        <div className='w-full'>
            ...
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className='w-full'>
                        <h1 className="text-xl lg:text-3xl font-bold"><span className='underlined'>WORLD-CUP</span></h1>
                        <div className="py-6">
                            <div className='w-full'>
                        ...
                        <div className="py-6">
                            <div className='w-full'>
                                ...
                                <ul className='text-start flex justify-center place-items-center w-full'>
                                    <ExternalLink href='https://github.com/Md-Mubarak-Hossain/worldCup' className='px-2 flex justify-center place-items-center '>
                        ...
                        <ExternalLink href='https://md-mubarak-hossain.github.io/worldCup/'><button className="btn btn-outline btn-primary">See live Project<VscLinkExternal className='mx-1'></VscLinkExternal></button></ExternalLink>
                    </div>
                </div>
            </div>
            <h2 className='w-full text-center pt-6 text-2xl text-violet-900 text-bold uppercase'>About world-cup website</h2>
