    ...
    return (
        <>
            ...
            <div className="modal-action">
                <label htmlFor="my-modal-5" className="btn btn-outline btn-warning"><ImCancelCircle className='text-x font-bold text-red-600'></ImCancelCircle></label>
                <ReactToPdf targetRef={ref} filename="div-blue.pdf">
                    {({ toPdf }) => (
                        <label onClick={toPdf} className="btn btn-outline btn-warning"><BsDownload className='text-x font-bold text-blue-900'></BsDownload></label>
                    )
                    }
                </ReactToPdf >
            </div>
