...
import siteImg from '../../components/assets/siteImg.png';
...
const Skills = () => {
    return (
        <div className=' w-full flex flex-col place-items-center'>
            ...
            <ul className="menu grid grid-cols-1  bg-base-100 w-full lg:w-11/12 mx-auto">
                ...
                <li className='p-2 w-full'>
                    <div className='lg:flex lg:border'>
                        <div className='w-full lg:w-1/4'>
                            <IoLogoHtml5 className="w-32 h-32 text-primary font-extrabold"></IoLogoHtml5>
                        </div>
                        <div className='w-full text-justify lg:w-3/4'>
                ...
                <li className='p-2 w-full'>
                    <div className='flex border'>
                        <div className='w-full lg:w-1/4'>
                            <IoLogoCss3 className="w-32 h-32 text-primary font-extrabold"></IoLogoCss3>
                        </div>
                        <div className='w-full text-justify lg:w-3/4'>
                ...
                <li className='p-2 w-full'>
                    <div className='flex border'>
                        <div className='w-full lg:w-1/4'>
                            <SiMongodb className="w-32 h-32 text-primary font-extrabold"></SiMongodb>
                        </div>
                        <div className='w-full text-justify lg:w-3/4'>
                ...
                <li className='p-2 w-full'>
                    <div className='flex border'>
                        <div className='w-full lg:w-1/4'>
                            <SiNodedotjs className="w-32 h-32 text-primary font-extrabold"></SiNodedotjs>
                        </div>
                        <div className='w-full text-justify lg:w-3/4'>
                ...
                <li className='p-2 w-full'>
                    <div className='flex border'>
                        <div className='w-full lg:w-1/4'>
                            <SiReact className="w-32 h-32 text-primary font-extrabold"></SiReact>
                        </div>
                        <div className='w-full text-justify lg:w-3/4'>
